  ...
  return [
    (n) => {
      ...
      return (
        ...
        e._x_effects.add(r),
        (t = () => {
          r !== void 0 && (e._x_effects.delete(r), K(r));
        }),
        r
      );
    },
...
var N = {},
  vt = !1;
function Gr(e, t) {
  if ((vt || ((N = W(N)), (vt = !0)), t === void 0)) return N[e];
  (N[e] = t),
    Ut(N[e]),
    typeof t == "object" &&
      t !== null &&
...
function bi(e = !1) {
  return function (t, n, r, i) {
    let o = t[n];
    if (!e && ((r = h(r)), (o = h(o)), !D(t) && We(o) && !We(r)))
      return (o.value = r), !0;
    ...
    for (let d = 0; d < f.length; d++) {
      ...
      re(G, ht, o),
        (G._x_refreshXForScope = (Bn) => {
          Object.entries(Bn).forEach(([zn, Wn]) => {
            ht[zn] = Wn;
          });
        }),
        m(() => {
